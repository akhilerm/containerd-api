...
func (c *eventsClient) Forward(ctx context.Context, in *ForwardRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/containerd.services.events.ttrpc.v1.Events/Forward", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Events_Forward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/containerd.services.events.ttrpc.v1.Events/Forward",
	}
...
var Events_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "containerd.services.events.ttrpc.v1.Events",
	...
	Metadata: "github.com/containerd/containerd-api/api/services/ttrpc/events/v1/events.proto",
}
